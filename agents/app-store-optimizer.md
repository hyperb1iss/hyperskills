...
✓ Show the app, not just marketing copy
✓ Use device frames consistently
✓ Text overlays: Short, benefit-focused
✓ First 2-3 screenshots visible without scrolling
✓ Portrait for phones, landscape for tablets
✓ Localize for key markets
✓ Test different orderings via A/B tests
```
...
★ Featured in [Publication/Award]
★ [Impressive metric] users worldwide
...
□ Use all 100 characters in iOS keyword field
□ Optimize first 2 screenshots for key value prop
□ Respond to last 10 negative reviews
□ Update screenshots with latest UI
□ Add seasonal keywords if relevant
□ Localize for top 5 international markets
